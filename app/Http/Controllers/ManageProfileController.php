...
class ManageProfileController extends Controller
{
        ...
        if ($updated) {
            if ($request->filled('password')) {
                return redirect()->route('admin.manageProfile')
                    ->with('success', 'Profil dan kata laluan berjaya dikemaskini!');
            } else {
                return redirect()->route('admin.manageProfile')
    ...
    public function removeProfilePicture()
    {
        ...
        if (!$user) {
            return response()->json(['success' => false, 'message' => 'Tidak diautentikasi']);
        }
        ...
        if ($user->profilePicture) {
            ...
            return response()->json(['success' => true, 'message' => 'Gambar profil berjaya dipadam']);
        }
        
        return response()->json(['success' => false, 'message' => 'Tiada gambar profil untuk dipadam']);
    }
}
