...
class GeranPadananController extends Controller
{
    /**
    ...
    {
        return view('Admin.geranpadanan');
    }
    ...
    {
        $geran = GeranPadanan::findOrFail($id);
