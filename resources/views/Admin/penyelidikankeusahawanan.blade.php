...
<head>
    ...
    <title>Penyelidikan dan Keusahawanan – {{ config('app.name') }}</title>
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h2 mb-0 text-gray-900 gradient-title">Penyelidikan dan Keusahawanan</h1>
          </div>
          ...
          <div class="card shadow-sm mb-4">
            <div class="card-body">
              ...
              <div class="row align-items-end">
                ...
                <div class="col-md-4">
                  <button type="button" id="filter-btn" class="btn" style="background:#123cc5ff;border-color:#123cc5ff;color:#fff;">
          ...
          <div class="card shadow-sm">
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped" id="penyelidikanTable" width="100%" cellspacing="0">
          ...
          <!-- Add/Edit Modal -->
          <div class="modal fade" id="penyelidikanModal" tabindex="-1" role="dialog" aria-labelledby="penyelidikanModalLabel">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="penyelidikanModalLabel">Tambah Penyelidikan dan Keusahawanan</h5>
                        <button type="button" class="close text-white" data-dismiss="modal" aria-label="Tutup">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form id="penyelidikanForm">
                        @csrf
                        <input type="hidden" id="penyelidikan_id">
            ...
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="modal-header bg-info text-white">
                  <h5 class="modal-title" id="viewDetailsModalLabel">Butiran Penyelidikan dan Keusahawanan</h5>
                  <button type="button" class="close text-white" data-dismiss="modal" aria-label="Tutup">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
  ...
  $(document).ready(function() {
    ...
    var table = $('#penyelidikanTable').DataTable({
      responsive: true,
      processing: true,
      serverSide: true,
      pageLength: 25,
      ...
      initComplete: function() {
          ...
          $('.dataTables_filter').append(
              ...
              '<a href="#" class="btn btn-primary ml-2" data-toggle="modal" data-target="#penyelidikanModal"  style="background:#123cc5ff;border-color:#123cc5ff;color:#fff;">' +
              '<i class="fas fa-plus"></i> Tambah Data</a>'
          );
      },
      ajax: {
        url: '/admin/penyelidikan-keusahawanan/data',
        data: function(d) {
    ...
    $('#penyelidikanForm').on('submit', function(e) {
      e.preventDefault();
      
      var formData = $(this).serialize();
      var id = $('#penyelidikan_id').val();
      var url = id ? '/admin/penyelidikan-keusahawanan/update/' + id : '/admin/penyelidikan-keusahawanan';
      var method = 'POST';
      ...
      $.ajax({
        ...
        success: function(result) {
          $('#penyelidikanModal').modal('hide');
          $('#penyelidikanForm')[0].reset();
          $('#penyelidikan_id').val('');
    ...
    $(document).on('click', '.view-btn', function() {
      ...
      $.ajax({
        url: '/admin/penyelidikan-keusahawanan/edit/' + id,
        type: 'GET',
    ...
    $(document).on('click', '.edit-btn', function() {
      ...
      $.ajax({
        ...
        type: 'GET',
        success: function(data) {
          $('#penyelidikanModalLabel').text('Edit Penyelidikan dan Keusahawanan');
          $('#penyelidikan_id').val(data.id);
    ...
    $('#confirmDelete').on('click', function() {
      ...
      $.ajax({
        url: '/admin/penyelidikan-keusahawanan/delete/' + id,
        type: 'POST',
        data: {
          '_token': '{{ csrf_token() }}'
        },
    ...
    $('#penyelidikanModal').on('hidden.bs.modal', function() {
      $('#penyelidikanModalLabel').text('Tambah Penyelidikan dan Keusahawanan');
      $('#penyelidikanForm')[0].reset();
      $('#penyelidikan_id').val('');
    });
