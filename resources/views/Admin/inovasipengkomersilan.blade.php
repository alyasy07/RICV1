...
<head>
    ...
    <title>Inovasi dan Pengkomersilan – {{ config('app.name') }}</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h2 mb-0 text-gray-900 gradient-title">Inovasi dan Pengkomersilan</h1>
          </div>
          ...
          <div class="card shadow-sm">
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped" id="inovasiTable" width="100%" cellspacing="0">
          ...
          <!-- Add/Edit Modal -->
          <div class="modal fade" id="inovasiModal" tabindex="-1" role="dialog" aria-labelledby="inovasiModalLabel">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="inovasiModalLabel">Tambah Inovasi dan Pengkomersilan</h5>
                    ...
                    <form id="inovasiForm">
                        @csrf
                        <input type="hidden" id="inovasi_id">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header bg-info text-white">
        <h5 class="modal-title" id="viewDetailsModalLabel">Butiran Inovasi dan Pengkomersilan</h5>
        <button type="button" class="close text-white" data-dismiss="modal" aria-label="Tutup">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
$(document).ready(function() {
  ...
  var table = $('#inovasiTable').DataTable({
    responsive: true,
    processing: true,
    serverSide: true,
    pageLength: 25,
    ...
    initComplete: function() {
        ...
        $('.dataTables_filter').append(
            ...
            '<a href="#" class="btn btn-primary ml-2" data-toggle="modal" data-target="#inovasiModal"  style="background:#123cc5ff;border-color:#123cc5ff;color:#fff;">' +
            '<i class="fas fa-plus"></i> Tambah Data</a>'
        );
    },
    ajax: {
      url: '/admin/inovasi-pengkomersilan/data',
      data: function(d) {
  ...
  $('#inovasiForm').on('submit', function(e) {
    ...
    var id = $('#inovasi_id').val();
    var url = id ? '/admin/inovasi-pengkomersilan/update/' + id : '/admin/inovasi-pengkomersilan';
  ...
  $(document).on('click', '.view-btn', function() {
    ...
    $.ajax({
      url: '/admin/inovasi-pengkomersilan/edit/' + id,
      type: 'GET',
  ...
  $(document).on('click', '.edit-btn', function() {
    ...
    $.ajax({
      ...
      type: 'GET',
      success: function(data) {
        $('#inovasiModalLabel').text('Edit Inovasi dan Pengkomersilan');
        $('#inovasi_id').val(data.id);
  ...
  $('#confirmDelete').on('click', function() {
    ...
    $.ajax({
      url: '/admin/inovasi-pengkomersilan/delete/' + id,
      type: 'POST',
      data: {
        '_token': '{{ csrf_token() }}'
      },
  ...
  $('#inovasiModal').on('hidden.bs.modal', function() {
    $('#inovasiModalLabel').text('Tambah Inovasi dan Pengkomersilan');
    $('#inovasiForm')[0].reset();
    $('#inovasi_id').val('');
  });
