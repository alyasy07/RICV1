...
<head>
    ...
    <title>Geran Padanan – {{ config('app.name') }}</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h2 mb-0 text-gray-900 gradient-title">Geran Padanan</h1>
          </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="addGeranModalLabel">Tambah Permohonan Geran Padanan</h5>
            ...
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="modal-header bg-info text-white">
                  <h5 class="modal-title" id="viewDetailsModalLabel">Butiran Permohonan Geran Padanan</h5>
                  <button type="button" class="close text-white" data-dismiss="modal" aria-label="Tutup">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
  ...
  <script>
    $(document).ready(function() {
      var table = $('#geranTable').DataTable({
        ...
        ajax: {
          url: '{{ route('admin.geranpadanan.data') }}'
        },
        columns: [
          { 
            data: null, 
      ...
      $('#geranForm').on('submit', function(e) {
        ...
        var url = id ? '{{ url("admin/geran-padanan") }}/' + id : '{{ route("admin.geranpadanan.store") }}';
      ...
      $(document).on('click', '.view-geran-btn', function() {
        ...
        $.ajax({
          url: '{{ url("admin/geran-padanan") }}/' + id + '/edit',
          type: 'GET',
      ...
      $(document).on('click', '.edit-geran-btn', function() {
        ...
        $.ajax({
          ...
          type: 'GET',
          success: function(data) {
            $('#addGeranModalLabel').text('Edit Permohonan Geran Padanan');
      ...
      $('#confirmDelete').on('click', function() {
        ...
        $.ajax({
          url: '{{ url("admin/geran-padanan") }}/' + id,
          type: 'DELETE',
          data: {
            '_token': '{{ csrf_token() }}'
          },
      ...
      $('#addGeranModal').on('hidden.bs.modal', function() {
        $('#addGeranModalLabel').text('Tambah Permohonan Geran Padanan');
