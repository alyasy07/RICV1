...
<head>
    ...
    <title>Geran Industri – {{ config('app.name') }}</title>
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h2 mb-0 text-gray-900 gradient-title">Geran Industri</h1>
          </div>
          ...
          <div class="card shadow-sm">
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped" id="geranTable" width="100%" cellspacing="0">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="addGeranModalLabel">Tambah Permohonan Geran Industri</h5>
                    ...
                    <form id="geranForm">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Institusi Terlibat <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" name="institusi_terlibat" required>
                            </div>
                            <div class="form-group">
            ...
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="modal-header bg-info text-white">
                  <h5 class="modal-title" id="viewDetailsModalLabel">Butiran Permohonan Geran Industri</h5>
                  <button type="button" class="close text-white" data-dismiss="modal" aria-label="Tutup">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  <div class="row">
                    <div class="col-md-12 mb-3">
                      ...
                      <p id="detail_nama_pemohon" class="mb-2"></p>
                    </div>
                    <div class="col-md-12 mb-3">
                      <label class="font-weight-bold">Institusi Terlibat:</label>
                      <p id="detail_institusi_terlibat" class="mb-2"></p>
                    </div>
                    <div class="col-md-12 mb-3">
  ...
  <script>
    $(document).ready(function() {
      var table = $('#geranTable').DataTable({
        responsive: true,
        processing: true,
        serverSide: true,
        pageLength: 25,
        ...
        order: [[1, 'asc']], // Default sort by Nama Pemohon
        ...
        ajax: {
          url: '{{ route('admin.granindustri.data') }}'
        },
        columns: [
          { 
            data: null, 
          ...
          { 
            data: 'institusi_terlibat', 
            name: 'institusi_terlibat',
            orderable: true,
            searchable: true
          },
          { 
      ...
      $('#geranForm').on('submit', function(e) {
        ...
        var url = id ? '{{ url("admin/geran-industri") }}/' + id : '{{ route("admin.granindustri.store") }}';
        ...
        $.ajax({
          ...
          success: function(result) {
            ...
            $('#geranTable').DataTable().ajax.reload();
          },
          error: function(xhr) {
      ...
      $(document).on('click', '.view-geran-btn', function() {
        ...
        $.ajax({
          url: '{{ url("admin/geran-industri") }}/' + id + '/edit',
          type: 'GET',
          success: function(data) {
            $('#detail_nama_pemohon').text(data.nama_pemohon || '-');
            $('#detail_institusi_terlibat').text(data.institusi_terlibat || '-');
      ...
      $(document).on('click', '.edit-geran-btn', function() {
        ...
        $.ajax({
          ...
          type: 'GET',
          success: function(data) {
            $('#addGeranModalLabel').text('Edit Permohonan Geran Industri');
            $('#geranForm').attr('data-id', id);
            $('input[name="nama_pemohon"]').val(data.nama_pemohon);
            $('input[name="institusi_terlibat"]').val(data.institusi_terlibat);
      ...
      $('#confirmDelete').on('click', function() {
        ...
        $.ajax({
          url: '{{ url("admin/geran-industri") }}/' + id,
          type: 'DELETE',
          data: {
            '_token': '{{ csrf_token() }}'
          },
      ...
      $('#addGeranModal').on('hidden.bs.modal', function() {
        $('#addGeranModalLabel').text('Tambah Permohonan Geran Industri');
