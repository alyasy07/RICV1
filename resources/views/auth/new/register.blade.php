    ...
    <div class="w-full max-w-md main-card-bg dark:border-gray-700 dark:shadow-2xl rounded-3xl shadow-2xl overflow-hidden p-1">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            <div>
                ...
                <x-text-input id="password_confirmation" class="input-fancy block mt-2 w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700/50 dark:text-white focus:border-primary-violet focus:ring-primary-violet dark:focus:border-primary-violet dark:focus:ring-primary-violet rounded-xl shadow-sm transition-all duration-300"
                              type="password"
