...
<body class="bg-bg-light dark:bg-bg-dark text-gray-900 dark:text-gray-100 font-sans flex items-center justify-center min-h-screen p-4 sm:p-0">
    ...
    <div class="w-full max-w-md main-card-bg dark:border-gray-700 dark:shadow-2xl rounded-3xl shadow-2xl overflow-hidden p-1">
        ...
        <div class="flex flex-col items-center justify-center mb-8">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400">Start your research journey with us</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            <div>
                ...
                <x-text-input id="name" class="input-fancy block mt-2 w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700/50 dark:text-white focus:border-primary-violet focus:ring-primary-violet dark:focus:border-primary-violet dark:focus:ring-primary-violet rounded-xl shadow-sm transition-all duration-300" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Your Name" />
            ...
            <div x-data="{ showPassword: false }">
                ...
                <div class="relative">
                    <x-text-input id="password" class="input-fancy block mt-2 w-full px-4 py-3 pr-12 border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700/50 dark:text-white focus:border-primary-violet focus:ring-primary-violet dark:focus:border-primary-violet dark:focus:ring-primary-violet rounded-xl shadow-sm transition-all duration-300"
                                  x-bind:type="showPassword ? 'text' : 'password'"
                                  name="password"
                                  required autocomplete="new-password"
                                  placeholder="Create a strong password" />
                    
                    <button type="button" @click="showPassword = !showPassword" class="absolute right-3 top-1/2 -translate-y-1/2 mt-1 text-gray-500 dark:text-gray-400 hover:text-primary-violet dark:hover:text-primary-violet transition-colors">
            ...
            <div x-data="{ showPasswordConfirmation: false }">
                ...
                <div class="relative">
                    <x-text-input id="password_confirmation" class="input-fancy block mt-2 w-full px-4 py-3 pr-12 border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700/50 dark:text-white focus:border-primary-violet focus:ring-primary-violet dark:focus:border-primary-violet dark:focus:ring-primary-violet rounded-xl shadow-sm transition-all duration-300"
                                  x-bind:type="showPasswordConfirmation ? 'text' : 'password'"
                                  name="password_confirmation" 
                                  required autocomplete="new-password"
                                  placeholder="Confirm your password" />
                    
                    <button type="button" @click="showPasswordConfirmation = !showPasswordConfirmation" class="absolute right-3 top-1/2 -translate-y-1/2 mt-1 text-gray-500 dark:text-gray-400 hover:text-primary-violet dark:hover:text-primary-violet transition-colors">
